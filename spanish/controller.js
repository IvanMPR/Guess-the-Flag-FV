...
//prettier-ignore
const america = new Continent(["antigua_y_barbuda", "argentina", "bahamas", "barbados", "belice", "bolivia", "brazil", "canadá", "chile", "colombia", "costa_rica", "cuba", "dominica", "república_dominicana", "ecuador", "el_salvador", "granada", "guatemala", "guyana", "haití", "honduras", "jamaica", "méxico", "nicaragua", "panamá", "paraguay", "perú", "san_cristóbal_y_nieves", "santa_lucía", "san_vicente_y_las_granadinas", "surinam", "trinidad_y_tobago", "uruguay", "estados_unidos", "venezuela"]);
//prettier-ignore
